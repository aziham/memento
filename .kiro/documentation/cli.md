...
Watch Demo
Loading image...![terminal showing Kiro logo and prompt](https://kiro.dev/images/home/cli.png?h=7fefd22e)
Terminal — 80×24
...
Loading image...
![](https://kiro.dev/images/cli/production.png?h=b7e9ae86)
...
Loading image...
![](https://kiro.dev/images/cli/agents.png?h=a0e3ea37)
...
Loading image...
![](https://kiro.dev/images/cli/hooks.png?h=00a29f59)

### Automated actions

Format code, run tests, manage logs, and more—all through automated shell commands.
Loading image...
![](https://kiro.dev/images/cli/code.png?h=afb6e933)
